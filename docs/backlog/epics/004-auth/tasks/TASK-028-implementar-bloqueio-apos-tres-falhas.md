# TASK-028 — Implementar bloqueio após três falhas
...
Implementar bloqueio após três falhas conforme as regras do domínio, arquitetura e backlog do MVP.
...
* TASK-027 concluída antes da finalização desta task.
