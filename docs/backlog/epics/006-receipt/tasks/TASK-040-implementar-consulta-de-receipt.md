# TASK-040 — Implementar consulta de Receipt
...
Implementar consulta de Receipt conforme as regras do domínio, arquitetura e backlog do MVP.
...
* TASK-021 concluída antes da finalização desta task.
