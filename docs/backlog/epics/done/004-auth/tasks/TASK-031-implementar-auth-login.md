# TASK-031 — Implementar `/auth/login`
...
Implementar `/auth/login` conforme as regras do domínio, arquitetura e backlog do MVP.
...
* TASK-029 concluída antes da finalização desta task.
