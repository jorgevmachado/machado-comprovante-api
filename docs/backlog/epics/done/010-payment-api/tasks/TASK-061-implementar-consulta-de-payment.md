# TASK-061 — Implementar consulta de Payment
...
Implementar consulta de Payment conforme as regras do domínio, arquitetura e backlog do MVP.
...
* TASK-060 concluída antes da finalização desta task.
