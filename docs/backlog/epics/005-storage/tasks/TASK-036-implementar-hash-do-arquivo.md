# TASK-036 — Implementar hash do arquivo
...
Implementar hash do arquivo conforme as regras do domínio, arquitetura e backlog do MVP.
...
* TASK-035 concluída antes da finalização desta task.
