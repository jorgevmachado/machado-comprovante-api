# TASK-044 — Implementar resolução de Institution
...
Implementar resolução de Institution conforme as regras do domínio, arquitetura e backlog do MVP.
...
* TASK-043 concluída antes da finalização desta task.
